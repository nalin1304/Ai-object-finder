...
if(Status!=""){
    ...
    for(i=0; i<objects.length; i++){
       ...
       document.getElementById("objects_name").innerHTML=Name+" found ";
       synth=window.speechSynthesis;
       utter=new SpeechSynthesisUtterance(Name+" found ");
       synth.speak(utter);
        }
        else{
            document.getElementById("objects_name").innerHTML=Name+" not found ";
        }
    }
